...
export const outputPath = './profile-summary-card-output/'
...
export const writeSVG = function (folder, filename, svgString) {
...
export const generatePreviewMarkdown = function (isInGithubAction) {
